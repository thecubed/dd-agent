...
The rules followed by the Agent for its `hostname` resolution are described on this [wiki page](https://github.com/DataDog/dd-agent/wiki/Agent-Hostname).
...
* [FEATURE] HDFS: New check collecting metrics on individual data nodes from the JMX-HTTP API of HDFS. See [#2235][] and [#2260][]
